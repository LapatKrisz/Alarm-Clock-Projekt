...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setObjectName(_fromUtf8("JarChris"))
        MainWindow.resize(740, 375)
        ...
        self.Time_LCD.display(strftime("%H"+":"+"%M"+":"+"%S")) #get time from Pi and display it +", "+"%A" +", "+"%a"
...
#End of code from Qt Designer
    ...
    def retranslateUi(self, MainWindow): #update the GUI window 
        ...
        MainWindow.setWindowTitle(_translate("JarChris", "JarChris", None))
        self.label.setText(_translate("JarChris", "Alarm is off", None))
        self.pushButton.setText(_translate("JarChris", "Set Alarm", None))

    
    def Time(self): #Function to compare current time with set time 
        self.Time_LCD.display(strftime("%H"+":"+"%M"+":"+"%S")) #+", "+"%a"+", "+"%A"
        ...
        if (self.current_h == self.alarm_h) and (self.current_m == self.alarm_m) and ((int(strftime("%S"))%15) == 0): #if the both time match 
            ...
            self.label.setText(_translate("JarChris",message1, None)) #display the message on GUI screen  
